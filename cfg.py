...
# change these for local dev or for stage
ax_api_url = 'https://api.ax-semantics.com/v1/{prefix}/{lookup}/thing/'
# ax_api_url = 'http://localhost:9000/v1/{prefix}/{lookup}/thing/'
